...
class TestRagConfigRoutes:
    ...
    def test_get_rag_config_success(self, client, mock_service, mock_workspace_service):
        ...
        workspace_id = "123"
        config = RagConfig(
            id=1, workspace_id=123, embedding_model="nomic-embed-text",
            embedding_dim=768, retriever_type="vector", chunk_size=1000,
    ...
    def test_create_rag_config_success(self, client, mock_service, mock_workspace_service):
        ...
        created_config = RagConfig(
            id=1, workspace_id=123, embedding_model="custom-model",
    ...
    def test_create_rag_config_already_exists(self, client, mock_service):
        ...
        mock_service.create_rag_config.side_effect = ValueError("RAG configuration already exists for this workspace")
    ...
    def test_update_rag_config_success(self, client, mock_service, mock_workspace_service):
        ...
        updated_config = RagConfig(
            ...
            chunk_overlap=200, top_k=12, rerank_enabled=False, rerank_model=None,
            created_at=datetime(2025, 1, 1, 12, 0, 0), updated_at=datetime(2025, 1, 1, 12, 0, 0)
        )
    ...
    def test_update_rag_config_validation_error(self, client, mock_service):
        ...
        mock_service.update_rag_config.side_effect = ValueError("chunk_size must be between 100 and 5000")
