...
from src.infrastructure.storage import BlobStorageType, create_blob_storage
...
class TestBlobStorageFactory:
    ...
    def test_create_s3_storage_explicitly(self) -> None:
        ...
        with (
            patch("src.config.S3_ENDPOINT_URL", "minio:9000"),
    ...
    def test_create_storage_from_config_s3(self) -> None:
        ...
        with (
            ...
            patch("src.config.S3_ENDPOINT_URL", "localhost:9000"),
