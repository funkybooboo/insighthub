...
from src.infrastructure.repositories.default_rag_configs.factory import create_default_rag_config_repository
...
class AppContext:
    ...
    def __init__(self, db=None):
        ...
        self.document_service = DocumentService(repository=document_repo, blob_storage=self.blob_storage)
        ...
        self.default_rag_config_service = DefaultRagConfigService(repository=default_rag_config_repo)

        # Initialize infrastructure components
        self.cache = create_cache()
        self.llm_provider = create_llm_provider(provider_type="ollama", base_url="http://localhost:11434", model_name="llama3.2")
