    ...
    useEffect(() => {
        ...
        const timer1 = setTimeout(() => {
            addNotification({
                ...
                message:
                    'Your research paper has been successfully processed and is ready for queries.',
                duration: 5000,
            });
        }, 1000);
            ...
            <div className="p-8 text-center">
                ...
                <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg">
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                        Notifications will appear automatically based on socket events from the
                        server.
                    </p>
                </div>
            </div>
...
const meta: Meta<typeof NotificationContainer> = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'Notification container that displays real-time updates from server events in the bottom left corner.',
            },
        },
    },
    tags: ['autodocs'],
        ...
        return (
            <>
                <div className="p-8 text-center">
                    ...
                    <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg">
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                            Connection status notifications appear automatically when the client
                            connects or disconnects from the server.
                        </p>
                    </div>
                </div>
