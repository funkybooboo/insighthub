...
const MockDocumentList = ({ workspaceId }: { workspaceId: number }) => {
  const mockDocuments = [
    {
      id: '1',
...
const meta: Meta<typeof MockDocumentList> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Document list display showing uploaded files with status indicators. (Mock implementation for Storybook)',
      },
    },
  },
  tags: ['autodocs'],
...
export const InUploadManager: Story = {
  render: () => (
    <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
      ...
      <div className="p-6">
        <MockDocumentList workspaceId={1} />
      </div>
    </div>
  ),
};