...
interface EmbeddingConfigSectionProps {
    ...
    algorithms?: {
        embedding_algorithms: Array<{ value: string; label: string; description?: string }>;
    };
        ...
        <div className="space-y-4">
            <div>
                ...
                >
                    ...
                    {algorithms?.embedding_algorithms?.map((algo) => (
...
interface RerankingConfigSectionProps {
    ...
    algorithms?: {
        rerank_algorithms: Array<{ value: string; label: string; description?: string }>;
    };
    onChange: (field: string, value: string | number | boolean | undefined) => void;
}
            ...
            {config.rerank_enabled && (
                <div>
                    ...
                    <select
                        ...
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                    >
                        <option value="">Select rerank model</option>
                        {algorithms?.rerank_algorithms?.map((algo) => (
                            <option key={algo.value} value={algo.value}>
                                {algo.label}
                            </option>
                        )) || (
...
interface GraphRagConfigSectionProps {
    config: {
    ...
    algorithms?: {
        entity_extraction_algorithms: Array<{ value: string; label: string; description?: string }>;
        relationship_extraction_algorithms: Array<{
            value: string;
            label: string;
            description?: string;
        }>;
        clustering_algorithms: Array<{ value: string; label: string; description?: string }>;
    };
    onChange: (field: string, value: string | number | boolean | undefined) => void;
}

export const GraphRagConfigSection: React.FC<GraphRagConfigSectionProps> = ({
    config,
    algorithms,
    onChange,
}) => (
        ...
        <div className="space-y-4">
            <div>
                ...
                <select
                    ...
                    onChange={(e) => onChange('entity_extraction_algorithm', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                >
                    <option value="">Select algorithm</option>
                    {algorithms?.entity_extraction_algorithms?.map((algo) => (
                        <option key={algo.value} value={algo.value}>
                            {algo.label}
                        </option>
                    ))}
            ...
            <div>
                ...
                <select
                    ...
                    onChange={(e) => onChange('relationship_extraction_algorithm', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                >
                    <option value="">Select algorithm</option>
                    {algorithms?.relationship_extraction_algorithms?.map((algo) => (
                        <option key={algo.value} value={algo.value}>
                            {algo.label}
                        </option>
                    ))}
            ...
            <div>
                ...
                <select
                    ...
                    onChange={(e) => onChange('clustering_algorithm', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                >
                    <option value="">Select algorithm</option>
                    {algorithms?.clustering_algorithms?.map((algo) => (
                        <option key={algo.value} value={algo.value}>
                            {algo.label}
                        </option>
                    ))}
