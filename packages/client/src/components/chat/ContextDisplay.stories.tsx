...
const MockContextDisplay = ({ context }: { context: Array<{ text: string; score: number; metadata: Record<string, unknown> }> }) => {
...
const meta: Meta<typeof MockContextDisplay> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Expandable display of retrieved context snippets with relevance scores. (Mock implementation for Storybook)',
      },
    },
  },
  tags: ['autodocs'],
