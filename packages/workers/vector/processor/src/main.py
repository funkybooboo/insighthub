"""Main entry point for the vector processor worker."""
...
from .vector_processor_worker import create_vector_processor_worker
...
async def main() -> None:
    ...
    logger.info("Starting Vector Processor Worker")
    ...
    consumer.connect()
    consumer.declare_queue("vector_processor_queue", "vector.embedder")
    ...
    # Create worker
    worker = create_vector_processor_worker(consumer, publisher, config)
    worker.set_queue_name("vector_processor_queue")
