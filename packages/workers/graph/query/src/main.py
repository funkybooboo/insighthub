"""Main entry point for the graph query worker."""
...
from .graph_query_worker import create_graph_query_worker
...
async def main() -> None:
    ...
    # Create worker
    worker = create_graph_query_worker(consumer, publisher, config)
